...
class user
{
	...
	int check1(int tnum) throws Exception
	{
		...
		Connection c=DriverManager.getConnection("jdbc:mysql://localhost:3306/railway_tckt_serv?autoReconnect=true&useSSL=false","root","Abhi@9090");
...
class railway
{
	...
	void main_menu() throws Exception
	{
		...
		switch(ch)
		{
			...
			case 2: u_user_login();
				break;
			default:System.out.println("Hello everyone");
				   System.exit(0);
				break;
	...
	void admin_mode() throws Exception
	{
		...
		switch(ch)
		{
			...
			case 7:main_menu();
				break;	
			default:System.out.println("Happy to see you");
					System.exit(0);
				break;
		}
	...
	void u_user_login() throws Exception
	{
		...
		switch(ch)
		{
			...
			case 3:main_menu();
				break;
			default:System.out.println("Good to see you");
					System.exit(0);
				break;
		}
	}
	...
	void user_mode() throws Exception
	{
		...
		if(ad.user_login()==1)
		{
			...
			switch(ch)
			{
				...
				case 4: main_menu();
					break;
				default:System.out.println("Hi again");
					 System.exit(0);
					break;
			}
		}
